...
REQUIRE_H1_LIQUIDITY_SWEEP = _get("VEE_REQUIRE_H1_LIQUIDITY_SWEEP", False)
H1_LQ_USE_PDH_PDL = _get("VEE_H1_LQ_USE_PDH_PDL", True)
H1_LQ_USE_SESSION = _get("VEE_H1_LQ_USE_SESSION", True)
H1_LQ_USE_INTERNAL = _get("VEE_H1_LQ_USE_INTERNAL", True)
H1_LQ_INTERNAL_LOOKBACK = _get("VEE_H1_LQ_INTERNAL_LOOKBACK", 10)
